<div class="footer">
    <div class="footer-content">
      <div class="footer-section about">
        <h1 class="logo-text">Haidar<span>Inspires</span></h1>
        <p>
          HaidarInspires is a fictional blog conceived for the purpose
          of practicing.
        </p>
        <!-- <br> -->

        <div class="contact">
          <i class="fa fa-phone"> &nbsp; (+963) 997 610 306</i>
    ...
    <div class="footer-bottom">
      <p>© Coding | Designed by Haidar Jbeily</p>
    </div>
  </div>
  <!-- // FOOTER -->